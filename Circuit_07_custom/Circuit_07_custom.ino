...
void loop()
{
  ...
  float voltage, degreesC, degreesF, thresholdTempF;
  int potentValue;
  ...
  // compute the trehsold temperature to be within the range of
  // 65 - 75 F
  thresholdTempF = ((1023 - potentValue)/100.0) + 65.0;
  
  // if the temperature is greater than or equal to the threshold
  // temperature, turn on the LED. otherwise turn it off.
  if (degreesF >= thresholdTempF){
